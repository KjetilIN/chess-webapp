...
const about: React.FC = () => {
    return (
        <div className='flex flex-col gap-5 items-center mt-3 bg-gray-100'>
            ...
            <ProfileCard name='Kjetil Indrehus' profession='NTNU Data Ingeniør' profilepic='/kjetil.jpeg' height={200} width={200}></ProfileCard>
            <ProfileCard name='Sondre Pedersen' profession='NTNU Datateknologi' profilepic='/sondre.jpg' height={200} width={200}></ProfileCard>
        </div>
    )
}
